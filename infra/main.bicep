metadata description = 'Provisions resources'

targetScope = 'resourceGroup'

param webContainerExists bool
...
var databaseName = 'cricketTracker'
var containerName = 'players'
...
module webFetchLatestImage './modules/fetch-container-image.bicep' = {
  name: 'agentPr-fetch-image'
  params: {
    exists: webContainerExists
